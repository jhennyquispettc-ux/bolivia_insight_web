            ...
            const r = await fetch(
              `${API}/payments/orders/${data.orderID}/capture`,
              {
                ...
                body: JSON.stringify({
                  ...
                  timeSlot: slot.time,
                  durationMin,
                  briefDates: `${brief.startDate} to ${brief.endDate}`,
                  briefRoute: `Wpp/Phone: ${brief.phone} | ${brief.origin} | with: ${brief.companions} | route: ${Array.isArray(brief.route) ? brief.route.join(', ') : brief.route}`.substring(0, 500),
                  briefQuestions: brief.questions,
                  briefLocation: brief.origin || 'No especificado',
                  googleAccessToken,
                }),
              },
            );
